  ...
  return (
    <div className="mycontainer">
      ...
      <div className="profileCompletion">
        ...
        <p>
          {t("Complete your profile to receive your token reward! To learn more about building a great profile, check out our NFTStudio24 Academy Course and get pro tips on Discord in the #top-notch-profile channel. When you reach 100% completion, you'll receive your token and can start exploring all the benefits!")}
        </p>
