              ...
              <li key={entry[0]}>
                <div className='user-panel'>
                  ...
                  <div className='txty-pnl'>
                    <Link href={entry[1].isStatic? `${DIRECTORY_STATIC_PATH +entry[0]}`:`/directory?directoryId=${entry[0]}`}>
                      <h4>{entry[1]?.company}</h4>
                    </Link>
                    <p>{entry[1]?.shortDescription}</p>
                    <Link
                      href={entry[1].isStatic? `${DIRECTORY_STATIC_PATH +entry[0]}`:`/directory?directoryId=${entry[0]}`}
