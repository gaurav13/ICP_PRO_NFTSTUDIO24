              ...
              <div className='Post-padding' key={index}>
                <div className={`Featured-Post press ${isHome ? '' : 'max'}`}>
                  ...
                  >
                    ...
                    >
                      <Link href={entry[1].isStatic ? `${ARTICLE_STATIC_PATH + entry[0]}` : `${ARTICLE_DINAMIC_PATH + entry[0]}`}>
                        <Image
                    ...
                    <div className='txt-pnl'>
                      ...
                      <div className='d-flex justify-content-center'>
                        <Link
                          href={entry[1].isStatic ? `${ARTICLE_STATIC_PATH + entry[0]}` : `${ARTICLE_DINAMIC_PATH + entry[0]}`}
                          style={{ width: '270px' }}
                        >
                          {t("Read More")}
                        </Link>
