                ...
                /> */}
                  ...
                  <div className='txt-pnl  mx-width-405' style={{ height: '135px' }}>
                    ...
                    <div className='img-pl'>
                      ...
                      <div>
                        <p style={{fontWeight:600 , fontSize:"18px"}}>{entry[1]?.founderName ?? ''}</p>
                        <p>{t('Founder')}</p>
                      </div>
                    </div>
                  </div>
...
export default function AllWeb3DirectoriesSearch({contentType,setIsData}:{contentType:string,setIsData:any}) {
