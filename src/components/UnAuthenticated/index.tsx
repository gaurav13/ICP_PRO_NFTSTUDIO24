...
import { ADDS_IMAGE_RATIO, ARTICLE_FEATURED_IMAGE_ASPECT } from '@/constant/sizes';
      ...
      <main id='main' className='new-home'>
        ...
        <div className='main-inner home'>
          ...
          <div className='section pmt-0' id='top'>
            <Row>
            <div className="col-xl-12 col-lg-12 col-md-12"><ins className="adsbygoogle" data-ad-layout="in-article" data-ad-format="fluid" data-ad-client="ca-pub-8110270797239445" data-ad-slot="3863906898"  style={{ display: 'block', textAlign: 'center' }}/>
            <Link href="https://www.bitget.com/"
                    ...
                    >
            <Image
                                src={"https://nftstudio24.com/wp-content/uploads/2024/07/promotess-img-.png"}
                                width={100}
                                height={100}
                  ...
                  <div className='general-post big'>
                    ...
                    <div className='txt-pnl'>
                      ...
                      <Link
                        ...
                        target='_self'
                      >
                        <h2 className='text-black homeEntryTitle'>
                          {latestEntry.length != 0
            ...
            <Row>
              ...
              blockchainEntries.length !== 0 && (
                <>
                  ...
                  >
                    <h2>
                      <Image src={iconrss} alt='RSS' /> {t('Blockchain News1')}
                    </h2>
                    <div className='spacer-20' />
                  </Col>
                  <EntryListNewHome
