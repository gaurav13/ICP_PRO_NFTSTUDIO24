...
export default function ServayQuestionListComponent({
  ...
  useEffect(() => {
    console.log("array", selectedQuestions)
  }, [selectedQuestions])
    ...
    <>
            ...
            <div className='table-inner-container'>
              {
                  ...
                  <Button className={`btn deleteAllbtn ${selectedQuestions?.length<=0?"disabled":""}`} onClick={handleDeleteQuizMultipleQuestions}>
                ...
                <tbody>
                  {servayQuestionList &&
                    servayQuestionList.map((item: any) => {
                      ...
                      return (
                        <tr key={id} className={selectedQuestions.includes(id) ? 'selected' : ''}>
      ...
      <Modal show={showDeleteModal} centered onHide={handleDeleteModleClose}>
        ...
        <h3 className='text-center'>
            {multipleDeleteQuestions ? t('Are you sure you want to delete these questions.')
