...
import { ALL_QUIZ_ROUTE_USER, ALL_SURVEY_ROUTE_USER } from '@/constant/routes';
                      ...
                      <ul className='all-filters-list'>
                        ...
                        {auth.state === 'initialized' && (<>
                          <li>
                            ...
                            >
                              <Link href={ALL_QUIZ_ROUTE_USER}   className="quizLink">{t('myQuiz')}</Link>
                            </span>
                          </li>
                            <li>
                            <span
                            ...
                            >
                              <Link href={ALL_SURVEY_ROUTE_USER} className='quizLink'>{t('mySurvey')}</Link>
