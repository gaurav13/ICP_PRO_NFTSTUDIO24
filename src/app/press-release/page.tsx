            ...
            <div className='event-innr'>
              <Col xl='12' lg='12' md='12'>
                <h1 className='podcastpageheading'>
                  {t(
                    "Boost Your Web3, DeFi, and Crypto Projects' Visibility with NFTStudio24 Press Release Service"
                  )}
                </h1>
                <p className='d-inline'>{siteConfig.pressreleasePgDetail}</p><a href="mailto:support@nftstudio24.com">support@nftstudio24.com</a>
