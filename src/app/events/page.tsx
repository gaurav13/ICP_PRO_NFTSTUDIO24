        ...
        <div className='main-inner event-detail-page'>
          <div className='inner-content'>
            <div className='event-innr'>
              ...
              <Col xl='12' lg='12' md='12'>
                <h1 className='podcastpageheading'>{t("Use NFTStudio24 to highlight Your Web3, Blockchain, and Crypto Events")}</h1>
                {/* <p>{siteConfig.eventsPgDetail}</p> */}
                <p dangerouslySetInnerHTML={{ __html: siteConfig.eventsPgDetail }} />
