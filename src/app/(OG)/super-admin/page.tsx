  ...
  return (
    <>
      ...
      >
        <Container className=''>
          <Row>
          {isLoading? <div className='d-flex justify-content-center'> <Spinner animation="border" variant="light" /></div>:userAuth?.isAdminBlocked? <Col className='d-flex flex-column align-items-center text-white'><div>
              ...
              </p></Col>:<Col className='d-flex flex-column align-items-center text-white'>
              <div>
                <Image src={logo} alt='Logo' height={150} width={150} />
              </div>
              <p className={`d-inline superadmintext my-4`}>
