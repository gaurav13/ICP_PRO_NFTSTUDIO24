                  ...
                  <div className='event-innr'>
                    <div className='flex-details-pnl'>
                      ...
                      <Dropdown.Menu>
                        ...
                        >
                          ...
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Acceptance
                              of Terms
                            </Link>
                          </li>
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Changes to
                              Terms
                            </Link>
                          </li>
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Use of the
                              {t('website')}
                            </Link>
                            <ul>
                              <li>
                              ...
                              <li>
                                ...
                                >
                                  <i className='fa fa-angle-right'></i> Account
                                  Registration
                                </Link>
                              </li>
                              <li>
                                ...
                                >
                                  <i className='fa fa-angle-right'></i> User
                                  Content
                                </Link>
                              </li>
                              <li>
                          ...
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Intellectual
                              Property
                            </Link>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Limitation
                              of Liability
                            </Link>
                          </li>
                          <li>
                            ...
                            >
                              <i className='fa fa-angle-right'></i> Governing
                      ...
                      <div className='right-detail-pnl'>
                        ...
                        <p>
                          Welcome to nftstudio24.com (“we,” “us,” “our,” or the
                        ...
                        <div className='padd-left'>
                          ...
                          <p>
                            ...
                            purpose.<br></br>
                            Impersonating any person or entity.<br></br>
                        ...
                        <p>
                          ...
                          <b>
                            <Link
                              href='http://support@nftstudio24.com'
                              target='_blank'
                            >
                              support@nftstudio24.com
                            </Link>
                          </b>{' '}
                          or by <br></br>phone at{' '}
                        ...
                        <p>
                          Welcome to the NFTStudio24 website and related
                          interactive features, products, services,
                          applications, or downloads (collectively, the
                          “Websites”) that are owned by NFTStudio24., including
                        ...
                        <p>
                          ...
                          notice should be sent to support@nftstudio24.com.
