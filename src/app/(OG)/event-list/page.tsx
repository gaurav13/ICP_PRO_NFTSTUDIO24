                    ...
                    <div className='release-post big'>
                      <div className='release-post-inner'>
                        <div className='txt-pnl'>
                          ...
                          <p>
                            The Fullerton Hotel Sydney No. 1 Martin Place,
                            Sydney NSW 2000, Australia The Fullerton Hotel
                            Sydney, No. 1 Martin Place,, Sydney NSW 2000 ,
                            Australia, Australia
                          </p>
                          <p>
                            {t(
                    ...
                    <div className='release-post big'>
                      <div className='release-post-inner'>
                        <div className='txt-pnl'>
                          ...
                          <h6>
                            World Tokenization Summit | RWA | Tokenization Event
                            in Dubai
                          </h6>
                          <p>
                            Dubai, United Arab Emirates Dubai United Arab
                            Emirates
                          </p>
                          <p>
                            Are you ready to embark on a thrilling journey into
                            the world of tokenization? Join us for a
                            one-of-a-kind event that will revolutionize the way
                            you perceive real-world assets. The Global
                            Tokenization Extravaganza is here to ignite your
                            imagination and empower you with the knowledge and
                            connections to shape the future.
                          </p>
                        </div>
                        <div className='img-pnl'>
                          <Link href='/'>
                    ...
                    <div className='release-post big'>
                      <div className='release-post-inner'>
                        <div className='txt-pnl'>
                          ...
                          <h6>
                            12th Global Blockchain Congress, UAE, Dubai 2023
                          </h6>
                          <p>
                          ...
                          <p>
                            Are you ready for an exciting and transformative
                            event in the world of blockchain? Look no further
                            than the 12th Global Blockchain Congress, happening
                            on December 11th and 12th, 2023,
                          </p>
                        </div>
                        <div className='img-pnl'>
                          <Link href='/'>
                    ...
                    <div className='release-post big'>
                      <div className='release-post-inner'>
                        <div className='txt-pnl'>
                          ...
                          <p>
                            Songshan Cultural & Creative Park No. 133, Guangfu S
                            Rd, Xinyi District, Taipei City, Taiwan
                            台北市信義區光復南路133號 Songshan Cultural &
                            Creative Park , No. 133, Guangfu S Rd,, Xinyi
