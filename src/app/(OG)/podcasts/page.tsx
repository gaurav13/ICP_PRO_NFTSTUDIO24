...
export default function NewPodcast() {
  ...
  const getAllPodcastList = async (all?: string) => {
  ...
  let getPodcastList = async () => {
    let podcastList = await getAllPodcastList();
                  ...
                  <Col xxl='8' xl='8' lg='12'>
                    <Row>
                      {isGetting ? (
                                ...
                                <Link
                                  ...
                                  href={
                                    item.isStatic
                                      ...
                                      : `/podcast?podcastId=${item.entryId}`
                                  }
                                >
                                  <div
                                    style={{
                        ...
                        <p className='text-center'>{t('No Podcast Found')}</p>
                      )}
                    </Row>
