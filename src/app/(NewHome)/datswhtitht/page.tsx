                      ...
                      <ul className='thumb-list'>
                        <li>
                          <span className='myanch'>
                            ...
                            />{' '}
                            {latestEntry.length != 0
                              ? formatLikesCount(Number(latestEntry[1].likes))
                              : 0}
                          </span>
                        </li>
                        <li>
                          <span className='myanch'>
                            <div className='viewbox'>
                              ...
                              {latestEntry.length != 0
                                ? formatLikesCount(Number(latestEntry[1].views))
                                : 0}
                            </div>
                          </span>
                        </li>
                  ...
                  <Col xl='9' lg='9'>
                    ...
                    <div className='flex-div-xs align-items-center heding'>
                      ...
                      <Link href='#' className='discover-btn'>
                        {t('View more')} <i className='fa fa-angle-right'></i>
                      </Link>
                    </div>
                  </Col>
                </Row>
                <div className='spacer-20'></div>
                <div className='shadow-slider'>{/* <ProductSlider /> */}</div>
