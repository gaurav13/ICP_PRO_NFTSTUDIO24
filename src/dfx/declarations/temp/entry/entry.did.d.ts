...
export interface anon_class_24_1 {
  ...
  'getAllEventsIds' : ActorMethod<[], Array<Key>>,
  'getAllWeb3Ids' : ActorMethod<[], Array<Key>>,
  ...
  'getUniqueDataList' : ActorMethod<
    ...
    { 'entries' : Array<[Key, ListPodcastItem]>, 'amount' : bigint }
  >,
  'getUserEntries' : ActorMethod<[UserId], Array<[Key, Entry]>>,
  'getUserEntriesList' : ActorMethod<
    [string, boolean, string, bigint, bigint],
    { 'entries' : Array<[Key, ListEntryItem]>, 'amount' : bigint }
  >,
  'getUserPodcast' : ActorMethod<[UserId], Array<[Key, Entry]>>,
